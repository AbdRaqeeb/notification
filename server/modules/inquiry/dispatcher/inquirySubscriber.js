...
const inquirySubscriber = async (next) => {
    try {
        // Name of queue
        const q = 'inquiry';
        ...
        ch.consume(q, async function (msg) {
            ...
            const {user_name, customer_name, email, c_email, title, phone, reference} = qm;
                                            ...
                                            >
                                                ...
                                                >
                                                    ...
                                                    <p style="text-align: justify;">
                                                        A new inquiry has been made regarding your
                                                        property: ${title} with reference: ${reference}
                                                    </p>
                                                    <p style="text-align: justify;">
                                                        Inquirer: ${customer_name} <br>
                                                        Phone Number: ${phone}
                                                        Email: ${c_email}
                                                    </p>
                                                    <p style="text-align: justify;">
...
export default inquirySubscriber;